...
\emph{The version you see here \href{https://github.com/habi/EAWAG-manuscript/compare/v1.0...c614d1218708bc438846661ff5c8ed6f15d3469b}{has been updated} since submission.}

This manuscript
(\href{https://habi.github.io/EAWAG-manuscript/v/c614d1218708bc438846661ff5c8ed6f15d3469b/}{permalink})
was automatically generated
from \href{https://github.com/habi/EAWAG-manuscript/tree/c614d1218708bc438846661ff5c8ed6f15d3469b}{habi/EAWAG-manuscript@c614d12}
on July 3, 2023.
...
A small bash script {[}\protect\hyperlink{ref-ZjgrPHTa}{14}{]} was used to generate redundant (archival) copies of the raw projection images and copy all the files to a shared network drive on the `Research Storage' infrastructure of the University of Bern, enabling collaboration on the data by all authorized persons at the same time.
...
Processed regions of interest were exported as \texttt{Nrrd} {[}\protect\hyperlink{ref-uYuz0opI}{22}, =Nrrd\&oldid=1085264080{]} files.
...
We used a homologous landmark scheme across one-half of the skull for higher density of shape information {[}\protect\hyperlink{ref-BDrCSu8p}{8},\protect\hyperlink{ref-15FafMZm5}{23}{]}, and landmarks were placed on each specimen using \emph{3D Slicer}.
To examine differences in shape across the species sampled, we performed a Generalized Procrustes Superimposition on the landmark data to remove the effects of location, size, and rotation from the analysis using the \emph{geomorph} package in \emph{R} (Version 4.2.1) with \emph{RStudio} (Version 2022.07.2+576) {[}\protect\hyperlink{ref-VPUOQA2P}{24}--\protect\hyperlink{ref-EwNL0C0Y}{26},\protect\hyperlink{ref-whEyWyQh}{27},\protect\hyperlink{ref-QfVloFVu}{28}{]}.
...
The simple three-dimensional visualization is integrated in the aforementioned \emph{Jupyter} notebook through an integrated visualization library {[}\protect\hyperlink{ref-a9ZL41Of}{29}{]} and is also shown in the \protect\hyperlink{supplementary-materials}{Supplementary Materials}.
...
The notebook for extracting the otoliths can be run in your browser without installing any additional software (via \emph{Binder} {[}\protect\hyperlink{ref-Q20Bxdsr}{30}{]}).
...
We thank the \texttt{manubot} project {[}\protect\hyperlink{ref-YuJbg3zO}{31}{]} for helping us write this manuscript collaboratively.
...
\CSLLeftMargin{12. }
\CSLRightInline{OpenSCAD. {[}cited 3 Jul 2023{]}. Available: \url{https://openscad.org}}
...
\CSLLeftMargin{14. }
\CSLRightInline{Haberthür D. Jupyter notebooks for image processing and data analysis of EAWAG Cichlids project. 2023. Available: \url{https://github.com/habi/EAWAG/blob/48197e8f6e7add0d3610ea1b2820f29c9a536bdf/rsync-fishes.sh}}
