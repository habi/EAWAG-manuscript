...
\emph{The version you see here \href{https://github.com/habi/EAWAG-manuscript/compare/v1.0...c6b7ff7c02d5425b675ce348cd38ac7a88cbfeb3}{has been updated} since submission.}

This manuscript
(\href{https://habi.github.io/EAWAG-manuscript/v/c6b7ff7c02d5425b675ce348cd38ac7a88cbfeb3/}{permalink})
was automatically generated
from \href{https://github.com/habi/EAWAG-manuscript/tree/c6b7ff7c02d5425b675ce348cd38ac7a88cbfeb3}{habi/EAWAG-manuscript@c6b7ff7}
on July 11, 2023.
...
We wrote a set of \emph{Jupyter} {[}\protect\hyperlink{ref-pQ6Wbz73}{15}{]} notebooks with \emph{Python} code to work with the acquired images and to extract the desired data.
...
All notebooks written for this work are available online {[}\protect\hyperlink{ref-1HteOscVd}{16}{]} and are extensively commented.
...
At first, \emph{all} log files of \emph{all} the scan present in the processed folder were read into a \emph{pandas} {[}\protect\hyperlink{ref-19qQOHlFN}{17},\protect\hyperlink{ref-U5AcoDOX}{18}{]} dataframe.
...
After displaying several parameters of both data acquisition and reconstruction for ruling out any operator error we used \emph{Dask} {[}\protect\hyperlink{ref-hj1CnyWB}{19}{]} to efficiently access the tomographic data on disk (in the end amounting to a total of nearly a million single images).
...
The notebook for extracting the otoliths can be run in your browser without installing any additional software (via \emph{Binder} {[}\protect\hyperlink{ref-Q20Bxdsr}{31}{]}).
...
\CSLLeftMargin{12. }
\CSLRightInline{OpenSCAD. {[}cited 11 Jul 2023{]}. Available: \url{https://openscad.org}}
...
\CSLLeftMargin{22. }
\CSLRightInline{Teem: nrrd: Definition of NRRD File Format. {[}cited 11 Jul 2023{]}. Available: \url{https://teem.sourceforge.net/nrrd/format.html}}
