...
We acquired datasets with (isometric) voxelsizes ranging from 3--50 μm.
...
I total we recorded 8.8 TB of projections images (`*.?if` files) for this project.
 ...
 We reconstructed the projection images with NRecon (Version 1.7.4.6, Bruker microCT, Kontich Belgium) with varying ring artefact and beam hardening correction values, depending on each fish.
